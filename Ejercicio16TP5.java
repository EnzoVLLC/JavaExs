public class Ejercicio16TP5 {
    ...
    public static void main(String[] args) {
        ...
        corrimientoizquierda(arreglo, corrimiento);
        imprimirarreglo(arreglo);
    }
    public static void corrimientoizquierda(int[] arreglo, int corrimiento) {

        int pos;

        for (pos = arreglo[corrimiento]; pos < MAX; pos++) {
